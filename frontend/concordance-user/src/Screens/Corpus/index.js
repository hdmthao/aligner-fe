...
const ParallelSentence = LazyPreload(() => import("../ParallelSentence"));
const Statistics = LazyPreload(() => import("../Statistics"));
const SearchContainer = LazyPreload(() => import("../Search"));

const Corpus = (props) => {
  let { path, url } = useRouteMatch();
  const routes = [
    { path: `${path}/`, exact: true, component: ParallelSentence },
    { path: `${path}/search`, exact: true, component: SearchContainer },
    { path: `${path}/statistics`, exact: true, component: Statistics },
  ];
  const [data, setData] = useState([
    {
      icon: (
        <svg
          ...
          style={{ enableBackground: "new 0 0 15.602 15.602" }}
          xmlSpace="preserve"
        >
          <g>
            <g id="c97_pause">
    ...
    },
    {
      icon: (
        <svg
          ...
          style={{ enableBackground: "new 0 0 394.497 394.497" }}
          xmlSpace="preserve"
        >
          <g>
            <path
              d="M181.239,84.373c-30.412,30.413-30.412,79.896,0,110.309c15.206,15.206,35.18,22.809,55.154,22.809
		...
		C284.657,91.624,284.823,91.813,285,91.994z"
            />
            <path
              d="M389.225,266.902l-72.44-72.44c11.022-16.057,16.958-35.038,16.958-54.935c0-26.002-10.127-50.449-28.514-68.835
